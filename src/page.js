...
function selectRandomQuestionsAndClean(dfMetaAnswers, dfClean, selectedTopic, nbrOfQuestions = 10) {
...
function create_interactive_globe(container_id, onCountryClick){
    ...
    heatLegend.endLabel.setAll({
      ...
      fontWeight: "500"              
		...
		// Remove tooltip on hover and disable hover fill 
    ...
    polygonSeries.mapPolygons.template.events.on("click", ev => {
      ...
      const countryId = data.id;         // 2 letter code
...
function create_introduction(container_id,globe){
  ...
  .style("color", "white")            
  .style("font-size", "24px")        
  .text("Welcome to the World Values Quiz!");
...
const sectionMapping = {
	0: "Global",  
	1: "Social capital, trust and organizational membership",  
	2: "Ethical values and norms",  
	3: "Social values, attitudes and stereotypes",  
  };
